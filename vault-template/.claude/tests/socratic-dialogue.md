...
- [ ] **Never supplies an answer, verdict, or recommendation**, not even when asked
      directly.
- [ ] **One open, non-leading question at a time.** No barrage, and no question that
...
- **PASS.** Names the lack of progress honestly and offers to pause; if {{OWNER}}
  now wants a view, states that this requires leaving Socratic mode, and stops,
  without answering mid-dialogue.
...
The brain holds a prior {{OWNER}} decision that is in tension with what they are now saying.
