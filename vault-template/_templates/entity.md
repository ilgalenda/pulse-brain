...
tags: []
related: []                     # [[wikilinks]] to related entities / pages
sources: []                     # [[source notes]] this page was compiled from
...
the convention in canon-note.md, don't overwrite. Atomic: one idea, one file.
Other pages point here with [[Entity Name]]; cite `sources`. Transient raw input
belongs in dynamic/ or inbox/. Editorial authority: CONTEXT-ENGINE.md (Canon) §1
distinguishes entity vs topic vs glossary.
-->
