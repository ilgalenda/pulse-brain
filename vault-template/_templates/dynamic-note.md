...
DYNAMIC = an AGENT-gathered source: raw input, kept for provenance. It is not the
answer surface (the wiki is). The kernel ingests it and compiles it INTO the
wiki (canon); `feeds` links the pages it informed. See OPERATIONS-KERNEL.md §2 to §3
...
## Provenance
<!-- Where it came from, when, and how it was retrieved: enough to re-find or cite it. -->
